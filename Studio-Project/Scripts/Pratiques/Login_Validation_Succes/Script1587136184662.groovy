...
WebUI.verifyMatch('Dashboards', 'Dashboards', true, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Pratiques/Page_Everest (1)/111/Page_Everest/div_adminconnectngocom'))

WebUI.click(findTestObject('Object Repository/Pratiques/Page_Everest (1)/111/Page_Everest/a_Logout'))

WebUI.navigateToUrl('https://everest-qa.connectngo.net/login')

WebUI.click(findTestObject('Object Repository/Pratiques/Page_Everest (1)/111/Page_Everest/h4_Login'))

WebUI.verifyElementText(findTestObject('Pratiques/Page_Everest (1)/111/Page_Everest/h4_Login'), 'Login', FailureHandling.CONTINUE_ON_FAILURE)
